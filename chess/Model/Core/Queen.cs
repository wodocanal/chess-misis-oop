...
public sealed class Queen(piece_color_t color, position_t position, int moveCount = 0) : Piece(color, position, moveCount) {
    ...
    public override Piece make_clone() => new Queen(get_color, get_position, get_move_count);
}
